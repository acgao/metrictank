...
func init() {
	...
	funcs = map[string]funcDef{
		...
		"highest":           {NewHighestLowestConstructor("", true), false},
		"highestAverage":    {NewHighestLowestConstructor("average", true), false},
		"highestCurrent":    {NewHighestLowestConstructor("current", true), false},
		"highestMax":        {NewHighestLowestConstructor("max", true), false},
		"isNonNull":         {NewIsNonNull, true},
		"lowest":            {NewHighestLowestConstructor("", false), false},
		"lowestAverage":     {NewHighestLowestConstructor("average", false), false},
		"lowestCurrent":     {NewHighestLowestConstructor("current", false), false},
